...
import (
	...
	application "github.com/rogeriobispo/go-hexagonal/application"
)
...
func (m *MockProductInterface) Enabled() error {
	m.ctrl.T.Helper()
...
func (mr *MockProductInterfaceMockRecorder) Enabled() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Enabled", reflect.TypeOf((*MockProductInterface)(nil).Enabled))
}
...
// MockProductPersistenseInterface is a mock of ProductPersistenseInterface interface.
type MockProductPersistenseInterface struct {
	ctrl     *gomock.Controller
	recorder *MockProductPersistenseInterfaceMockRecorder
}

// MockProductPersistenseInterfaceMockRecorder is the mock recorder for MockProductPersistenseInterface.
type MockProductPersistenseInterfaceMockRecorder struct {
	mock *MockProductPersistenseInterface
}

// NewMockProductPersistenseInterface creates a new mock instance.
func NewMockProductPersistenseInterface(ctrl *gomock.Controller) *MockProductPersistenseInterface {
	mock := &MockProductPersistenseInterface{ctrl: ctrl}
	mock.recorder = &MockProductPersistenseInterfaceMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockProductPersistenseInterface) EXPECT() *MockProductPersistenseInterfaceMockRecorder {
	return m.recorder
}

// Get mocks base method.
func (m *MockProductPersistenseInterface) Get(id string) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", id)
	ret0, _ := ret[0].(application.ProductInterface)
	ret1, _ := ret[1].(error)
...
// Get indicates an expected call of Get.
func (mr *MockProductPersistenseInterfaceMockRecorder) Get(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockProductPersistenseInterface)(nil).Get), id)
}

// Save mocks base method.
func (m *MockProductPersistenseInterface) Save(product application.ProductInterface) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Save", product)
	ret0, _ := ret[0].(application.ProductInterface)
	ret1, _ := ret[1].(error)
...
// Save indicates an expected call of Save.
func (mr *MockProductPersistenseInterfaceMockRecorder) Save(product interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Save", reflect.TypeOf((*MockProductPersistenseInterface)(nil).Save), product)
}
